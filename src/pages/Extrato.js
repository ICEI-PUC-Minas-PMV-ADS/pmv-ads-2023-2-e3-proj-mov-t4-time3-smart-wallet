...
import {
  getLancamentos,
  deleteLancamento,
} from "../services/lancamento.services";
              ...
              .filter((item) => {
                const includesSearchText =
                  ...
                  (item.tipo.toLowerCase() === "receita" &&
                    "receita".includes(searchText.toLowerCase())) ||
                  (item.tipo.toLowerCase() === "despesa" &&
                    "despesa".includes(searchText.toLowerCase()));
              ...
              .map((item) => (
                <Card key={item.id} style={styles.card}>
                  ...
                  <View style={styles.buttonContainer}>
                    ...
                    >
                      <Icon name="trash" size={20} color="darkblue" />
                    </TouchableOpacity>
                  </View>
                </Card>
              ))}
