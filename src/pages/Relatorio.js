...
<LineChart
  data={{
    ...
    datasets: [
      {
        data: somasReceitasPorMes, // Substitua pelo seu array de receitas por mês
        color: (opacity = 1) => `rgba(0, 128, 0, ${opacity})`, // Cor para receitas (verde)
        strokeWidth: 2,
      },
      {
        data: somasDespesasPorMes, // Substitua pelo seu array de despesas por mês
  ...
  chartConfig={{
    ...
    labelColor: (opacity = 1) => `rgba(0, 0, 0, ${opacity})`, // Cor dos rótulos do eixo X
    style: {
      borderRadius: 16,
    },
    propsForDots: {
